...
parser.add_argument("-N", "--No", nargs='+', help="Packets that should not be dumped")
...
if args.Explain:
    print("Dump undecoded: {},  Dump Decoded: {}, Dump TimeStamp: {}".format(Dump_Undecoded,Dump_Decoded,Print_ACK_NAK,Dump_TimeStamp))
